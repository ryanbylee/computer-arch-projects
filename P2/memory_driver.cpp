...
int main (int argc, char* argv[]) // the program runs like this: ./program <filename> <mode>
{
	...
	L1_miss_rate = (double)myCache.getStat().missL1/((double)myCache.getStat().accL1 + (double)myCache.getStat().missL1);
	L2_miss_rate = (double)myCache.getStat().missL2/((double)myCache.getStat().accL2 + (double)myCache.getStat().missL2);
	victim_miss_rate = (double)myCache.getStat().missVic/((double)myCache.getStat().accVic + (double)myCache.getStat().missVic);
